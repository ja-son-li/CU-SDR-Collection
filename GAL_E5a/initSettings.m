...
settings.fileName           = "C:\Users\jasp9644\Downloads\E5_Test\test_L5_24.bin";
...
settings.acqCohCodePeriods = 1;
settings.acqCohTime = 2*settings.acqCohCodePeriods*(settings.codeFreqBasis/settings.codeLength)/1000;
settings.acqCohFFTLength = settings.acqCohTime*2*1000;
% Non-coherent integration times 
settings.acqNonCohCodes = 5;
settings.acqNonCohTime = settings.acqNonCohCodes*settings.acqCohTime; %[ms]
